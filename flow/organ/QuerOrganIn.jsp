                            ...
                            <div class="tabbable">
                                <ul id="inbox-tabs" class="nav nav-tabs padding-18 tab-size-bigger">
                                    ...
                                    <li class="addN" onclick="isSubmint();">
                                        <i class="icon-xinzeng iconfont"></i><span>填报</span>
                                    </li>
...
//            }
	 ...
	 var laypage = layui.laypage
      ...
      //分页参数设置 这些全局变量关系到分页的功能
        ...
        function getNoktD1(obj){
          $.ajax({
              type:"post",
              url:"${ctxPath}/organParty/findAudingOrgan.action",
              data:{'page': obj,
        ...
        function getNoticeItm1(data){
        	...
        	for(var i=0;i<data.length;i++){
        		...
        		listItem.find("#set").html("<a  style='padding-left:0px;width: 161px;' href='${ctxPath}/organParty/partyUserInLook.action?flowUUid="+notd.flowUUid+"'>查看</a>");//partyLook
     ...
     getNoktD1(1); 
     function isSubmint(){
    	 window.location.href="${ctxPath}/organParty/toUpsert.action";
     }
</script>
</body>
</html>
