				...
				<form id="study" method="post" action="${ctxPath}/pc/studyPc/upsert.action"
					...
					<!-- <div class="form-group organr">
						...
						<div class="col-sm-10">
							...
							<div class="f-left" style="width: 120px; padding-top: 10px">
								<button type="button" class="btn bgm-teal btn-block comp"
									comp="type:'fileupload',previewImgId:'logoimg',valueId:'logo',isPrivate:true">选择上传图片</button>
							</div>
							<span class="help-block m-b-none">视频logo可以选择某一帧的图片。</span>
						</div>
					</div> -->
					<div class="form-group">
	...
	<script type="text/javascript">
		$().ready(function() {
			...
			$("#offset").change(function() {
				...
				if (f) {
					$.post("${ctxPath}/file/videoCover.action", {
						fileid : f,
						offset : os
					}, function(data) {
						if (data)
