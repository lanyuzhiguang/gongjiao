		...
		<div class="card">
			<div class="card-body card-padding">
				<div class="my-titlebar">
					<a href="${ctxPath}/pc/study/gained/groupPc/toQueryweb.action" class="btn-link">
				...
				<form id="gained" method="post"
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<div class="fg-line">
								<input  value="${ffgained.createTimeFormat}" name="createTime" disabled="disabled"  type="text" class="create_Time form-control">
							</div>
						</div>
					</div>
					<div class="form-group organr">
						...
						<div class="col-sm-10">
							<c:forEach items="${ffgained.imageUrls}" var="image">
