...
<head>
    ...
    <link href="${ctxPath}/modulepc/css/audio.css" rel="stylesheet"/>
</head>
...
<div class="main-content">
    <div class="main-content-inner">
        ...
        <i class="fa fa-angle-double-left"></i>返回
                        ...
                        <div class="col-sm-12 sudioListW">
                            <div class="audioList">
                                <ul id="allnews">
                                    <li>
                                        <p><i class="ace-icon fa icon-yinpin1  iconfont"></i>题专题专题专题专题专题专题专题专题专题专题专题</p><span>XXXX-MM-YY</span>
                                    </li>
...
<script type="text/javascript">
    jQuery(function($) {
        $(".audioList ul li:odd").css({"background":"#EDEDED"});
...
function getShopCustomesInfo(data){
  ...
  $.each(data,function(v,o){
	  ...
	  s+='<li><p><i class="ace-icon fa icon-yinpin1  iconfont"></i>'
	       +'<a href=\"../study/tostudydetail.action?id='+o._id+'&type='+o.type+'\"  target=\"_blank\" style=\"color:#393939;\">'+o.title+'</a>'
	       +'</p><span>'+o.createTime+'</span></li>'
