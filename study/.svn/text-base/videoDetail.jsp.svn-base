...
<head>
    ...
    <link href="${ctxPath}/modulepc/css/videoDetail.css" rel="stylesheet"/>
</head>

<body class="no-skin" oncontextmenu=self.event.returnValue=false onselectstart="return false" onunload="score()">
...
<div class="main-content">
    <div class="main-content-inner">
        <div class="page-content">
         ...
         <video width="80%" height="60%" controls="controls" id="srcurl2">
...
function score() {
	...
	if(tc > 0) {
		$.ajax({
		      ...
		      data:{'type': '1','typeId':newdata._id,'time': tc,'libSore': 0},
  ...
  $.ajax({
    ...
    //  async:false,
      ...
      data:{'page': currentPageAllAppoint,'size':limitAllAppoint,
    	  'parentId': "0",'type|integer': 1,'typeId': '${studyId}'},
      success:function(data){
	  ...
	  $.each(data,function(v,o){
		  ...
		  if(o.avatar==null||o.avatar==""){
			  if(o.tenantId != '5416928080940976859')
				  ...
				  else simg="<img src=\"${ctxPath}/modulepc/img/rehead1.png\">"; 
	      }else{ 
				...
				function() {
					...
					if(c != '' && c.length> 0) {
						  $.ajax({
						      ...
						      data:{'type': 1,'typeId':'${studyId}','content': c},
						      success:function(data){
									$("#form-field-1").val('');
									getComments();
								    toPage();
