...
<head>
    ...
    <link href="${ctxPath}/modulepc/css/exam.css" rel="stylesheet"/>
</head>
            ...
            <div class="row">
                <div class="col-xs-12 examB">
                    ...
                    <!--div class="col-sm-3 hotTopice">
                        <div class="hotT">
                            <div class="hotm">热门</div>
                            <div class="hotmList">
                                <ul>
                                    <li>
                                        <div class="listWrapper">
                                            <p>试标题考试标题考试标题考试标考试标题考试标题<span>YYYY-MM-DD</span></p>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="listWrapper">
                                            <p>题考试标题考试标题考试标考试标题考试标题<span>YYYY-MM-DD</span></p>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="listWrapper">
                                            <p>考试标题考试标题考试标考试标题考试标题<span>YYYY-MM-DD</span></p>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="listWrapper">
                                            <p>标题考试标题考试标考试标题考试标题<span>YYYY-MM-DD</span></p>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="listWrapper">
                                            <p>试标题考试标题试标题考试标题考试标题考试标考试标题考试标题<span>YYYY-MM-DD</span></p>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="listWrapper">
                                            <p>题考试标题试标题考试标题考试标题考试标考试标题考试标题<span>YYYY-MM-DD</span></p>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="listWrapper">
            ...
            <div class="row divpage">
                <div class="col-xs-12">
                    <div class="dataTables_paginate paging_simple_numbers" id="sample-table-2_paginate">
                        <ul class="pagination">
                            <li class="paginate_button previous disabled" aria-controls="sample-table-2" tabindex="0" id="sample-table-2_previous">
                                <a href="#"><</a>
                            </li>
                            <li class="paginate_button pageCode active" aria-controls="sample-table-2" tabindex="0">
                                <a href="#">1</a>
                            </li>
                            <li class="paginate_button pageCode" aria-controls="sample-table-2" tabindex="0">
                                <a href="#">2</a>
                            </li>
                            <li class="paginate_button pageCode " aria-controls="sample-table-2" tabindex="0">
                                <a href="#">3</a>
                            </li>
                            <li class="paginate_button next" aria-controls="sample-table-2" tabindex="0" id="sample-table-2_next">
                                <a href="#">></a>
                            </li>
                        </ul>
                    </div>
