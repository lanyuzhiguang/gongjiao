...
function getShopCustomesInfo(data){
  var s = "";
   $.each(data,function(v,o){
	  s+='<li><div class="videoImg"><img src="http://qiniu.thdangjian.com/'+o.imageUrl+'">'+
         '<a href=\"../study/toreslib.action?categoryId='+o._id+'&type='+o.type+'\" style=\"color:#393939;\"><div class="outerBox"><p class="goryName">'+o.categoryName+'</p><p class="classily">';
		if(o.type == 1 ){
			s+='<font color=\"red\">视频</font>&nbsp;&nbsp;&nbsp;&nbsp;共'+o.resourceNumber+'节</p></div></a></div></li>';
		}else if(o.type ==2){
			s+='<font color=\"red\">音频</font>&nbsp;&nbsp;&nbsp;&nbsp;共'+o.resourceNumber+'节</p></div></a></div></li>';
		}else if(o.type == 3){
			s+='<font color=\"red\">文档</font>&nbsp;&nbsp;&nbsp;&nbsp;共'+o.resourceNumber+'节</p></div></a></div></li>';
		}
       }); 
