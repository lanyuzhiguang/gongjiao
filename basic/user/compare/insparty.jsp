	...
	<div class="container">
		<div class="card">
			<div class="my-titlebar">
				<a href="${ctxPath}/excelData/index.action" class="btn-link"> 
			...
			<div class="card-body card-padding">
				<form id="user" method="post" enctype="multipart/form-data" 
					action="${ctxPath}/excelData/upExcelComUser.action" class="form-horizontal" >
					<input type="hidden" id="_id" name="_id"> <input
						...
						<c:if test="${uptype != 2}">
							<div class="form-group">
								<div class="col-sm-2">
									选择根据模板填写了，用户信息excel文件 <br/>*导入功能已经更新，请重新下载模板，工具模板导入信息！<br>模板更新数据：2017.9.30
								</div>
								<div class="col-sm-6">
									<div class="fg-line">
