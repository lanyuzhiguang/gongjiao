...
<body class="gray-bg">
	...
	<script type="text/javascript">
				...
				.ready(
						function() {
							...
							$("#newPartyUser").click(function(){
									document.location.href=_ctxPath+"/userExcel/indsqparty.do";
								}
							);
									...
									.click(
											function() {
												...
												/* document.location.href = _ctxPath
														+ "/basic/user/toPartyUpsert.action?bumenId="
														+ ckBumid//$("#bumenId").val()
														+ "&isNew=true"; */
											});
							// 默认选择parentId指定节点
												...
												colModel : [
														{
															...
															formatter : function(
																	...
																	options,
																	rowObject) {
																var v = "<a href='${ctxPath}/basic/user/toPartyUpsert.action?bumenId=${param.bumenId}&userId="
																		+ cellvalue
																		+ "' class='m-r-10'>详情</a>";
																...
																v += "<a href='javascript:void(0);' onclick='reset(\""
																	+ cellvalue
																	+ "\")' class='m-r-10'>重置密码</a>";
																v += "<a href='${ctxPath}/rolebumen/toQuery.action?accountId="
																		+ cellvalue
																		+ "'>授权</a>";
																return v;
															}
		...
		function addedit(obj1,obj2,obj3,obj4,obj5){
			document.location.href = _ctxPath+"/basic/user/toPartyUpsert.action?bumenId="+obj1+"&userId="+obj2+"&name="+obj3+"&userID="+obj4+"&phone="+obj5;
		}
