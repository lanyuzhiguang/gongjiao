					...
					<div class="col-sm-9">
						<form id="searchForm" name="searchForm" method="get" class="form-horizontal" action="" >
							...
							<div class="form-group">
								<div class="col-sm-9 col-sm-offset-1" style="margin-left:0;padding-left: 14px;">
									<div class="col-sm-12" style="padding-left:0">
										<div class="input-group fg-float">
										<div class="fg-line">
											<label >选择时间
												<input style="width: 8%;margin-left:8px;" type="text" id="yeartime" value="" name="yeartime" >
												...
												<button id="search" class="btn btn-primary m-l-9" type="submit">查询</button>
												<button id="noParty" class="btn btn-primary m-l-9"
												type="button" style="width: 26%;" >未缴人员缴费提醒</button>
											</label>
										</div>
										</div>
									</div>
							...
							function clk(e, treeId, node) {
							 ...
							 var bumenIds=[];
					            ...
					            $("#searchForm").submit(function() {
					            	 mmc=document.getElementById("month").value;
					            		...
					            		return false;
						            	 ...
						            	 $.ajax({
						            	      ...
						            	      success:function(data){
						            	    	  if(data) alert("通知发送成功！！");
						            	    	  else alert("通知发送失败！！");
						            	      }
						            	  });
									//document.location.href=_ctxPath+"/feerecord/noParty.action";
								}
							  );
							  ...
							  var lastSel = null;
					            ...
					            $("#userTable")
					                .grid(
										{
											url : _ctxPath
											+ "/feerecord/queryBumenIdsno.action",
											postData : $("#searchForm")
												.formobj(),
											shrinkToFit : false,
											multiselect: false,
