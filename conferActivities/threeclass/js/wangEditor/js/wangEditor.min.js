	...
	! function(a, b) {
		...
		c.fn = c.prototype, c.$body = b("body"), c.$document = b(document), c.$window = b(a), c.userAgent = navigator.userAgent, c.getComputedStyle = a.getComputedStyle, c.w3cRange = "function" == typeof document.createRange, c.hostname = location.hostname.toLowerCase(), c.websiteHost = "wangeditor.github.io", c.isOnWebsite = c.hostname === c.websiteHost, c.docsite = "http://www.kancloud.cn/wangfupeng/wangeditor2/113961", a.wangEditor = c, c.plugin = function(a) {
			...
			a.fn.command = function(a, b, c, d) {
				...
				var e = this,
					f = e.currentRange();
				return f ? (e.undoRecord(), this.restoreSelection(f), b.call(e), this.saveSelection(), this.restoreSelection(), c && "function" == typeof c && c.call(e), e.txt.insertEmptyP(), e.updateValue(), e.updateMenuStyle(), setTimeout(d, 200), void(a && a.preventDefault())) : void(a && a.preventDefault())
			...
			c.fn.init = function() {
				...
				"DIV" === e.get(0).nodeName ? (a = e, a.addClass("wangEditor-txt"), a.attr("contentEditable", "true")) : a = b('<div class="wangEditor-txt" contentEditable="true">' + f + "</div>"), d.ready(function() {
					c.insertEmptyP()
				}), c.$txt = a, c.contentEmptyHandle(), c.bindEnterForDiv(), c.bindTabEvent(), c.bindPasteFilter(), c.bindFormatText(), c.bindHtml()
				...
				function a(e) {
					if(e && e.nodeType && e.nodeName) {
						var f, h = e.nodeName.toLowerCase(),
							i = e.nodeType;
						if(3 === i || 1 === i) {
							if("div" === h) return f = b(e), void f.children().each(function() {
								a(this)
							});
							if(j.indexOf(h) >= 0) g += c(e);
							else if(3 === i) g += "<p>" + e.textContent + "</p>";
							else {
								if(["meta", "style", "script", "object", "form", "iframe"].indexOf(h) >= 0) return;
								f = b(d(e)), g += b("<div>").append(f).html()
							}
						}
					}
				}
				...
				h.on("paste", function(c) {
					if(f.config.pasteFilter) {
						g = "";
						var d, e, h = c.clipboardData || c.originalEvent.clipboardData;
						if(h && h.getData) d = h.getData("text/html"), d ? (e = b("<div>" + d + "</div>"), a(e.get(0))) : (d = h.getData("text/plain"), d && (d = d.replace(/[ ]/g, "&nbsp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/\n/g, "</p><p>"), g = "<p>" + d + "</p>", g = g.replace(/<p>(https?:\/\/.*?)<\/p>/gi, function(a, b) {
							return '<p><a href="' + b + '" target="_blank">' + b + "</p>"
						})));
						else {
							if(!window.clipboardData || !window.clipboardData.getData) return;
							if(g = window.clipboardData.getData("text"), !g) return;
							g = "<p>" + g + "</p>", g = g.replace((new RegExp("\n", "g"), "</p><p>"))
						}
						g && f.command(c, "insertHtml", g)
					}
				})
				...
				d.html = function(a) {
					var c;
					return "div" === f && (c = b.fn.html.call(d, a)), void 0 === a ? c = b.fn.html.call(d) : (c = b.fn.html.call(d, a), e.val(a)), void 0 === a ? c : void 0
				}
			}
		}), b(function(a, b) {
			var c = a.Txt,
			...
			c.fn.render = function() {
				...
				var a = this.editor,
					...
					e = c - d;
				e = 50 > e ? 50 : e, b.height(e), this.initMaxHeight(e, d)
			}, c.fn.initMaxHeight = function(a, c) {
				var d = this.editor,
					e = d.menuContainer.$menuContainer,
					f = this.$txt,
					g = b("<div>");
				if(window.getComputedStyle && "max-height" in window.getComputedStyle(f.get(0))) {
					var h = parseInt(d.$valueContainer.css("max-height"));
					if(isNaN(h)) return;
					g.css({
						"max-height": h - c + "px",
						"overflow-y": "auto"
						...
						f.parent().scrollTop() > 10 ? e.addClass("wangEditor-menu-shadow") : e.removeClass("wangEditor-menu-shadow")
					}), f.wrap(g)
				}
				...
				var a = this.$txt,
					c = a.children();
				return 0 === c.length ? void a.append(b("<p><br></p>")) : void("<br>" !== c.last().html() && a.append(b("<p><br></p>")))
			...
			}, a.config.mapAk = "TVhjYjq1ICT2qqL5LdS8mwas", a.config.uploadImgUrl = "", a.config.uploadTimeout = 2e4, a.config.uploadImgFns = {}, a.config.customUpload = !1, a.config.pasteFilter = !0
		}), b(function(a, b) {
			a.UI = {}, a.UI.menus = {
				"default": {
			...
			a.createMenu(function(c) {
				function d() {
					var a = i.$codeTextarea,
						b = g.txt.$txt,
						c = a.val();
					g.config.jsFilter && (c = c.replace(/<script[\s\S]*?<\/script>/gi, "")), b.html(c)
				}
				var e = "source";
				if(c(e)) {
					var f, g = this,
			...
			a.createMenu(function(c) {
				...
				if(c(d)) {
					var e, f, g, h = this,
						...
						p = b("<span> 列</span>");
					for(f = 0; 10 > f; f++) {
						for(e = b('<tr index="' + (f + 1) + '">'), g = 0; 10 > g; g++) e.append(b('<td index="' + (g + 1) + '">'));
						l.append(e)
					}
			...
			a.createMenu(function(c) {
				...
				if(c(d)) {
					var e = this,
						...
						i = b('<div class="panel-tab"></div>'),
						j = b('<div class="tab-container"></div>'),
						k = b('<div class="content-container"></div>');
					b.each(g, function(a, c) {
						...
						k.append(h), b.each(f, function(a, c) {
							var d = b('<a href="#" commandValue="' + c + '"></a>'),
								f = b("<img>");
							f.css({
								width: e + "px",
								height: e + "px"
						...
						var d = this,
							e = d.dropPanel;
						return e.isShowing ? void e.hide() : (e.show(), void(d.imgLoaded || (k.find("img").each(function() {
							var c = b(this),
								d = c.attr("_src");
							c.on("error", function() {
								a.error("加载不出表情图片 " + d)
			...
			a.createMenu(function(c) {
				...
				if(c(d)) {
					var e = this,
						f = e.config.lang,
						g = /^\s*(http:\/\/|https:\/\/).+(\.swf|\.ogg|\.mp4|\.webm)/i,
						h = new a.Menu({
							editor: e,
							id: d,
							title: f.video,
						...
						j = ['<video src="#{videoUrl}" controls="controls" width="#{width}" height="#{height}">', "</video>", "<p><br></p>"].join(""),
						k = b("<div></div>"),
						l = b('<div style="margin:20px 10px;"></div>'),
						m = b('<input type="text" class="block" placeholder="*.swf, *.mp4, *.ogg, *.webm"/>');
					l.append(m);
					var n = b('<div style="margin:20px 10px;"></div>'),
						o = b('<input type="text" value="480" style="width:50px;text-align:center;"/>'),
						p = b('<input type="text" value="360" style="width:50px;text-align:center;"/>');
					n.append("<span> " + f.width + " </span>").append(o).append("<span> px &nbsp;&nbsp;&nbsp;</span>").append("<span> " + f.height + " </span>").append(p).append("<span> px </span>");
					var q = b("<div></div>"),
						r = b('<button class="right">' + f.submit + "</button>"),
						s = b('<button class="right gray">' + f.cancel + "</button>");
					q.append(r).append(s), k.append(l).append(n).append(q), s.click(function(a) {
						a.preventDefault(), m.val(""), h.dropPanel.hide()
					}), r.click(function(a) {
						a.preventDefault();
						var c, d = b.trim(m.val()),
							f = parseInt(o.val()),
							k = parseInt(p.val());
						return d ? g.test(d) ? isNaN(f) || isNaN(k) ? void alert("宽度或高度不是数字！") : (c = /.swf/i.test(d) ? i.replace(/#{videoUrl}/gi, d).replace(/#{width}/gi, f).replace(/#{height}/gi, k) : j.replace(/#{videoUrl}/gi, d).replace(/#{width}/gi, f).replace(/#{height}/gi, k), e.command(a, "insertHtml", c), void m.val("")) : (alert("视频链接格式错误！"), void h.dropPanel.focusFirstInput()) : void h.dropPanel.focusFirstInput()
					}), h.dropPanel = new a.DropPanel(e, h, {
						$content: k,
						width: 400
					}), e.menus[d] = h
			...
			a.createMenu(function(e) {
				...
				var g = "location";
				if(e(g)) {
					if(d++ > 1) return void a.error("目前不支持在一个页面多个编辑器上同时使用地图，可通过自定义菜单配置去掉地图菜单");
					var h = this,
						i = h.config,
						j = i.lang,
						k = i.mapAk;
					...
					window.baiduMapCallBack = function() {
						function b(b) {
							var d = b.name;
							e.setCenter(d), q.val(d), a.placeholder && r.focus();
							var f, g;
							c ? (g = function(a) {
								"keyup" === a.type && 13 === a.keyCode && a.preventDefault(), f && clearTimeout(f), f = setTimeout(l.searchMap, 500)
							}, q.on("keyup change paste", g), r.on("keyup change paste", g)) : (g = function() {
								if(!o.is(":visible")) return void clearTimeout(f);
								var a = "",
									b = "",
									c = q.val(),
									d = r.val();
					...
					h.menus[g] = n;
					var o = b("<div></div>"),
						p = b('<div style="margin:10px 0;"></div>'),
						q = b('<input type="text"/>');
					q.css({
						width: "80px",
						"text-align": "center"
					});
					var r = b('<input type="text"/>');
					r.css({
						width: "300px",
						"margin-left": "10px"
					}).attr("placeholder", j.searchlocation);
					var s = b('<button class="right link">' + j.clearLocation + "</button>");
					p.append(s).append(q).append(r), o.append(p), s.click(function(a) {
						r.val(""), r.focus(), l.clearLocations(), a.preventDefault()
					});
					var t = b('<div id="' + l.mapContainerId + '"></div>');
					t.css({
						height: "260px",
						width: "100%",
						position: "relative",
					...
					u.css({
						...
						left: "50%",
						"margin-left": "-50px"
					}), t.append(u), o.append(t);
					var v = b('<div style="margin:10px 0;"></div>'),
						w = b('<button class="right">' + j.submit + "</button>"),
						x = b('<button class="right gray">' + j.cancel + "</button>"),
						y = b('<label style="display:inline-block;margin-top:10px;color:#666;"></label>'),
						z = b('<input type="checkbox">');
					y.append(z).append('<span style="display:inline-block;margin-left:5px;">  ' + j.dynamicMap + "</span>"), v.append(y).append(w).append(x), o.append(v), x.click(function(a) {
						a.preventDefault(), f(), n.dropPanel.hide()
					}), w.click(function(a) {
						a.preventDefault();
						var c, d, e, g = l.map,
							i = z.is(":checked"),
						...
						if(d = i ? "http://ueditor.baidu.com/ueditor/dialogs/map/show.html#" : "http://api.map.baidu.com/staticimage?", d = d + "center=" + n + "," + o + "&zoom=" + p + "&width=" + r + "&height=" + s, k.length > 0 && (d += "&markers=", b.each(k, function(a, b) {
							...
							if(k.length > 1) return void alert(j.langDynamicOneLocation);
						...
						} else h.command(a, "insertHtml", '<img style="max-width:100%;" src="' + d + '"/>', f)
					}), n.dropPanel = new a.DropPanel(h, n, {
						$content: o,
						width: 500
					}), n.onRender = function() {
						k === a.baiduMapAk && a.warn("建议在配置中自定义百度地图的mapAk，否则可能影响地图功能，文档：" + a.docsite)
					}, n.clickEvent = function(a) {
						var b = this,
							c = b.dropPanel,
							d = !1;
						return c.isShowing ? void c.hide() : (l.map || (d = !0), l.initMap(), c.show(), void(d || r.focus()))
					}
				}
			})
		}), b(function(a, b) {
			...
			a.createMenu(function(d) {
				function e(a) {
					...
					e.click(function(a) {
						function c() {
							var a;
							i && (a = p.attr("class"), a !== i + " hljs" && p.attr("class", i + " hljs")), p.html(e)
						}

						function d() {
							h.restoreSelectionByElem(q), l()
						}
						a.preventDefault();
						var e = m.val();
						...
						if(i && (j = ' class="' + i + ' hljs"'), e = e.replace(/&/gm, "&amp;").replace(/</gm, "&lt;").replace(/>/gm, "&gt;"), !k.selected) {
							var o = g.replace("{#langClass}", j).replace("{#content}", e);
							return void h.command(a, "insertHtml", o, l)
						}
						var p, q = h.getSelfOrParentByName(f, "pre");
						q && (q = h.getSelfOrParentByName(f, "code")), q && (p = b(q), h.customCommand(a, c, d))
					})
				}
			...
			a.createMenu(function(b) {
				...
				if(b(d)) {
					...
					l.clickEvent = function(b) {
						var d = g.$editorContainer;
						d.addClass("wangEditor-fullscreen"), f = d.css("z-index"), d.css("z-index", i);
						var h = g.txt.$txt;
						e = h.height();
						var j = g.menuContainer;
						h.height(a.$window.height() - j.height()), g.menuContainer.$menuContainer.attr("style", ""), k = !0, g.isFullScreen = !0, c = a.$window.scrollTop()
					}, l.clickEventSelected = function(b) {
						var d = g.$editorContainer;
						d.removeClass("wangEditor-fullscreen"), d.css("z-index", f);
						var h = g.txt.$txt;
						e && h.height(e), k = !1, g.isFullScreen = !1, null != c && a.$window.scrollTop(c)
					}, l.updateSelectedEvent = function(a) {
						return k
					}, g.menus[d] = l
				}
			})
			...
			b.plugin(function() {
				function a(a) {
					...
					d.onload = function() {
						...
						c.command(null, "insertHtml", e), b.log("已插入图片，地址 " + a), d = null
					}, d.onerror = function() {
						b.error("使用返回的结果获取图片，发生错误。请确认以下结果是否正确：" + a), d = null
					}, d.src = a
				}
				var c = this,
					d = c.config.uploadImgFns;
				d.onload || (d.onload = function(c, d) {
					b.log("上传结束，返回结果为 " + c), 0 === c.indexOf("error|") ? (b.warn("上传失败：" + c.split("|")[1]), alert(c.split("|")[1])) : (b.log("上传成功，即将插入编辑区域，结果为：" + c), a(c))
				}), d.ontimeout || (d.ontimeout = function(a) {
					b.error("上传上图片发生错误"), alert("上传上图片发生错误")
				}), d.onerror || (d.onerror = function(a) {
					b.error("上传图片超时"), alert("上传图片超时")
				})
			})
		...
		function(a, b, c) {
			a.FileReader && a.FormData && b.plugin(function() {
				function c(b, c) {
					var d, e = a.atob(b.split(",")[1]),
						f = new ArrayBuffer(e.length),
						g = new Uint8Array(f);
					for(d = 0; d < e.length; d++) g[d] = e.charCodeAt(d);
					return new Blob([f], {
						type: c
					})
				}
				...
				h && (f.xhrUploadImg = function(a) {
					function g() {
						r && clearTimeout(r), s && s.abort && s.abort(), j.preventDefault(), p && p(s), f.hideUploadProgress()
					}
					var j = a.event,
						k = a.base64,
						l = a.fileType || "image/png",
						m = a.name || "wangEditor_upload_file",
						n = a.loadfn,
						o = a.errorfn,
						p = a.timeoutfn,
						q = "png";
					if(l.indexOf("/") > 0 && l.split("/")[1] && (q = l.split("/")[1]), b.isOnWebsite) return b.log("预览模拟上传"), void d(k, j);
					var r, s = new XMLHttpRequest,
						t = new FormData;
					s.onload = function() {
						r && clearTimeout(r), n && n(s.responseText, s), f.hideUploadProgress()
					}, s.onerror = function() {
						r && clearTimeout(r), j.preventDefault(), o && o(s), f.hideUploadProgress()
					}, s.upload.onprogress = e, t.append(m, c(k, l), b.random() + "." + q), s.open("POST", h, !0), s.send(t), r = setTimeout(g, i), b.log("开始上传...并开始超时计算")
				})
			})
		}(window, window.wangEditor, window.jQuery),
		function(a, b, c) {
			b.plugin(function() {
				...
				var d = this,
					...
					g = d.$editorContainer,
					h = g.width(),
					i = c('<div class="wangEditor-upload-progress"></div>'),
					j = !1;
				d.showUploadProgress = function(b) {
					k && clearTimeout(k), a(), i.show(), i.width(b * h)
				};
				var k;
				d.hideUploadProgress = function(a) {
					k && clearTimeout(k), a = a || 750, k = setTimeout(b, a)
				}
			})
		}(window, window.wangEditor, window.jQuery),
		function(a, b, c) {
				...
				d.fn = d.prototype, d.fn.clear = function() {
					...
					if(!a._hasRender) {
						...
						var d = a.fileAccept,
							...
							h = c('<input type="file" ' + e + " " + g + "/>"),
							i = c('<div style="visibility:hidden;"></div>');
					...
					var d = this,
						...
						k = h.onerror,
						l = new FileReader;
					return i && j && k ? (b.log("开始执行 " + f + " 文件的上传"), l.onload = function(a) {
						b.log("已读取" + f + "文件");
						...
						e.xhrUploadImg({
							...
							errorfn: function(a) {
								c(), b.isOnWebsite && alert("wangEditor官网暂时没有服务端，因此报错。实际项目中不会发生"), k(a)
							},
							timeoutfn: function(a) {
								c(), b.isOnWebsite && alert("wangEditor官网暂时没有服务端，因此超时。实际项目中不会发生"), j(a)
							}
						})
					}, void l.readAsDataURL(a)) : void b.error("请为编辑器配置上传图片的 onload ontimeout onerror 回调事件")
				}, b.UploadFile = d
			}
		}(window, window.wangEditor, window.jQuery),
		function(a, b, c) {
			if(!a.FileReader || !a.FormData) {
				...
				d.fn = d.prototype, d.fn.clear = function() {
					...
					if(!a._hasRender) {
						var e = a.uploadUrl;
						b.log("渲染dom");
						var f = "iframe" + b.random(),
							g = c('<iframe name="' + f + '" id="' + f + '" frameborder="0" width="0" height="0"></iframe>'),
							h = a.multiple,
							i = h ? 'multiple="multiple"' : "",
							j = c("<p>选择图片并上传</p>"),
							k = c('<input type="file" ' + i + ' name="wangEditorFormFile"/>'),
							l = c('<input type="submit" value="上传"/>'),
							m = c('<form enctype="multipart/form-data" method="post" action="' + e + '" target="' + f + '"></form>'),
							n = c('<div style="margin:10px 20px;"></div>');
						m.append(j).append(k).append(l), n.append(m), n.append(g), a.$input = k, a.$iframe = g;
						var o = new b.Modal(d, void 0, {
							$content: n
						});
						a.modal = o, a._hasRender = !0
					}
				}, d.fn.bindLoadEvent = function() {
					function a() {
						var a = c.trim(g.document.body.innerHTML);
						a && (h(a), b.clear(), b.hideModal())
					}
					var b = this;
					if(!b._hasBindLoad) {
						var d = b.editor,
						...
						f.attachEvent ? f.attachEvent("onload", a) : f.onload = a, b._hasBindLoad = !0
					}
				}, d.fn.show = function() {
					function a() {
					...
					var a = this;
					b.log("使用 form 方式上传"), a.render(), a.clear(), a.show()
				}, b.UploadFile = d
			}
		}(window, window.wangEditor, window.jQuery),
		function(a, b, c) {
		...
		function(a, b, c) {
			b.plugin(function() {
				...
				var g, h = this,
					...
					j = i.$txt,
					k = !1,
					l = c('<div class="txt-toolbar"></div>'),
					m = c('<div class="tip-triangle"></div>'),
					n = c('<a href="#"><i class="wangeditor-menu-img-trash-o"></i></a>'),
					o = c('<a href="#"><i class="wangeditor-menu-img-search-minus"></i></a>'),
					p = c('<a href="#"><i class="wangeditor-menu-img-search-plus"></i></a>');
				j.on("click", "table", function(b) {
					var d = c(b.currentTarget);
					return a(), g && g.get(0) === d.get(0) ? void setTimeout(f, 100) : (g = d, e(), b.preventDefault(), void b.stopPropagation())
		...
		function(a, b, c) {
			b.userAgent.indexOf("MSIE 8") > 0 || b.plugin(function() {
				...
				function h(a) {
					var b = !1;
					return c.each(x, function(d, e) {
						var f = !1;
						return c.each(e.imgs, function(c, d) {
							return a === d ? (b = !0, f = !0, !1) : void 0
						}), f ? !1 : void 0
					}), b
				}
				var i, j = this,
					k = j.txt,
					l = k.$txt,
					m = (j.$editorContainer, !1),
					n = c('<div class="img-drag-point"></div>'),
					o = c('<div class="txt-toolbar"></div>'),
					p = c('<div class="tip-triangle"></div>'),
					q = c('<a href="#"><i class="wangeditor-menu-img-trash-o"></i></a>'),
					r = c('<a href="#"><i class="wangeditor-menu-img-search-minus"></i></a>'),
					s = c('<a href="#"><i class="wangeditor-menu-img-search-plus"></i></a>'),
					t = c('<a href="#"><i class="wangeditor-menu-img-align-left"></i></a>'),
					u = c('<a href="#"><i class="wangeditor-menu-img-align-justify"></i></a>'),
					v = c('<a href="#"><i class="wangeditor-menu-img-align-right"></i></a>'),
					w = !1,
					x = j.config.emotions;
				l.on("mousedown", "img", function(a) {
					...
					var d = c(b.currentTarget),
						e = d.attr("src");
					if(e && !h(e)) {
						if(a(), i && i.get(0) === d.get(0)) return void setTimeout(g, 100);
		...
		function(a, b, c) {
			b.plugin(function() {
				var a = this,
					c = a.config.menuFixed;
				if(c !== !1 && "number" == typeof c) {
					var d = parseFloat(b.$body.css("margin-top"), 10);
					isNaN(d) && (d = 0);
					var e, f = a.$editorContainer,
						g = f.offset().top,
						h = f.outerHeight(),
						i = a.menuContainer.$menuContainer,
						j = i.css("position"),
						k = i.css("top"),
						l = i.outerHeight(),
						m = i.offset().top;
					...
					b.$window.scroll(function() {
						if(!a.isFullScreen) {
							...
							f >= m && g + h > f + c + l + 30 ? (i.css({
//								position: "fixed",
                                position: "relative",
//                             top: "63px"
//								top: c
							}), i.width(e), b.$body.css({
//								"margin-top": d + l
                                 "margin-top": "63px"
							}), a._isMenufixed || (a._isMenufixed = !0)) : (i.css({
//								position: j,
								position: "relative",
//								top: k
//								top: "63px"
							}), i.css("width", "100%"), b.$body.css({
								"margin-top": d
							}), a._isMenufixed && (a._isMenufixed = !1))
						}
					})
				}
			})
		...
		function(a, b, c) {
			b.plugin(function() {
				var a = this,
					d = a.config.customUpload;
				if(d) {
					if(a.config.uploadImgUrl) return alert("自定义上传无效，详看浏览器日志console.log"), void b.error("已经配置了 uploadImgUrl ，就不能再配置 customUpload ，两者冲突。将导致自定义上传无效。");
					var e = a.$uploadContent;
					e || b.error("自定义上传，无法获取 editor.$uploadContent");
					var f = c('<a href="#" class="upload-icon-container"><i class="wangeditor-menu-img-upload"></i></a>');
					e.append(f);
					var g = "upload" + b.random(),
						h = "upload" + b.random();
					f.attr("id", g), e.attr("id", h), a.customUploadBtnId = g, a.customUploadContainerId = h
				}
			})
