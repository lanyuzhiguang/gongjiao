	...
	<div class="container">
		<div class="card">
			<div class="my-titlebar">
				<a href="${ctxPath}/pc/feePc/toQuery.action" class="btn-link">
					<i class="fa fa-angle-double-left"></i>返回
				</a>
			</div>
			<div class="card-body card-padding">
				<form id="user" method="post" enctype="multipart/form-data" 
					action="${ctxPath}/pc/feePc/upExcelFee.action" class="form-horizontal" >
					<input type="hidden" id="_id" name="_id"> <input
						...
						<c:if test="${uptype != 2}">
							<div class="form-group">
								<div class="col-sm-2">
									<label class="control-label">选择根据模板填写了<br>党费基础信息excel文件</label>
								</div>
								<div class="col-sm-6">
									<div class="fg-line">
...
<script type="text/javascript">
	$("#dowtemp").click(function(){
		...
		+ "/pc/feePc/doFeeinfoExcel.action";
	});
</script>
</html>
