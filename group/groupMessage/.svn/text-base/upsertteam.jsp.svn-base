		...
		<div class="card">
			<div class="card-body card-padding">
				<div class="my-titlebar">
					<a href="${ctxPath}/pc/group/groupMessagePc/toQueryteam.action?groupId=${param.groupId}" class="btn-link"> <i
	...
	<script type="text/javascript">
		$().ready(function() {
			...
			$("#cancelBtn").click(function() {
				document.location.href = _ctxPath + "/pc/group/groupMessagePc/toQueryteam.action?groupId=${param.groupId}";
			});
		});
	</script>
</body>
