...
<body class="gray-bg">
		...
		<div class="card">
			<div class="card-body card-padding">
				<div class="my-titlebar">
					<a href="${ctxPath}/pc/group/favorGroupPc/toQueryweb.action" class="btn-link"> <i
	...
	startDate.config.max.date = '';
				...
				$("#messageTable")
					...
					{
						url : _ctxPath
								+ "/pc/group/groupMessagePc/queryweb.action?groupId=${param.groupId}",
						postData : $("#searchForm")
								.formobj(),
						shrinkToFit : false,
						...
						colModel : [
								{
									...
									formatter : function(
											...
											options,
											rowObject) {
										var v = "<a href='${ctxPath}/pc/group/groupMessagePc/toUpsertweb.action?groupId=${param.groupId}&id="
												+ cellvalue
												+ "' class='m-r-10'>详情</a>";
										return v;
									}
