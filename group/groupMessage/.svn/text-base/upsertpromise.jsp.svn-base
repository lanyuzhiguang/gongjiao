		...
		<div class="card">
			<div class="card-body card-padding">
				<div class="my-titlebar">
					<a href="${ctxPath}/pc/group/groupMessagePc/toQuerypromise.action?groupId=0" class="btn-link"> <i
				...
				<form id="groupMessage" method="post"
					action="${ctxPath}/pc/group/groupMessagePc/upsertpromise.action" class="form-horizontal">
						...
						<div class="col-sm-10">
							<div class="fg-line">
								<input type="text" class="form-control "
									   id="content" name="content" readonly="readonly"/>
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<div id="imagesDiv" class="col-sm-12"></div>
	...
	<script type="text/javascript">
		$().ready(function() {
			...
			$("#cancelBtn").click(function() {
				document.location.href = _ctxPath + "/pc/group/groupMessagePc/toQuerypromise.action?groupId=0";
			});
		});
	</script>
</body>
