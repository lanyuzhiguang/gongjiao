...
<body class="gray-bg">
	...
	startDate.config.max.date = '';
				...
				$("#messageTable")
					...
					{
						url : _ctxPath
								+ "/pc/group/groupMessagePc/queryteam.action?groupId=${param.groupId}",
						postData : $("#searchForm")
								.formobj(),
						shrinkToFit : false,
						...
						colModel : [
								{
									...
									formatter : function(
											...
											options,
											rowObject) {
										var v = "<a href='${ctxPath}/pc/group/groupMessagePc/toUpsertteam.action?groupId=${param.groupId}&id="
												+ cellvalue
												+ "' class='m-r-10'>详情</a>";
										return v;
									}
