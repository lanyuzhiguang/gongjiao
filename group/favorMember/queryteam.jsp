			...
			function() {
				$("#newMember").click(function() {
					document.location.href = _ctxPath
							+ "/pc/group/favorMemberPc/toInsertteam.action?groupId=${param.groupId}";
				});
				...
				$("#memberTable")
					...
					{
						url : _ctxPath
								+ "/pc/group/favorMemberPc/queryteam.action?groupId=${param.groupId}",
						postData : $("#searchForm")
								.formobj(),
						shrinkToFit : false,
						colNames : [ "操作", "成员名称", "角色",
						...
						colModel : [
								{
									...
									formatter : function(
											...
											options,
											rowObject) {
										var v = "<a href='${ctxPath}/pc/group/favorMemberPc/toUpsertteam.action?groupId=${param.groupId}&id="
												+ cellvalue
												+ "' class='m-r-10'>详情</a>";
