...
<body class="gray-bg">
	...
	<script type="text/javascript">
						...
						function() {
									...
									.click(
											function() {
												document.location.href = _ctxPath
														+ "/manage/activity/category/toUpsert.do";
											});
							...
							$("#categoryTable")
									.grid(
											{
												url : _ctxPath
														+ "/manage/activity/category/query.do",
												postData : $("#searchForm")
														.formobj(),
												colNames : [ "分类名称", "排序", "操作" ],
												colModel : [
														...
														},
														{
															...
															formatter : function(
																	...
																	options,
																	rowObject) {
																var v = "<a href='${ctxPath}/manage/activity/category/toUpsert.do?categoryId="
																		+ cellvalue
																		+ "' class='m-r-10'>详情</a>";
		...
		function removeCategory(categoryId) {
			layer.confirm('确定要删除新闻分类信息?', function(index) {
				layer.close(index);
				var url = _ctxPath + "/manage/activity/category/remove/"
						+ categoryId + ".do";
