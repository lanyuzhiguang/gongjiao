		...
		<div class="card">
			<div class="card-body card-padding">
				<div class="my-titlebar">
					<a href="${ctxPath}/manage/activity/category/toQuery.do"
						class="btn-link"> <i class="fa fa-angle-double-left"></i>返回
					</a>
					<c:if test="${ffcategory._id == null}">
								新建活动分类信息
							</c:if>
					<c:if test="${ffcategory._id != null}">修改活动分类信息
							</c:if>
				</div>
				...
				<form id="activityCategory" method="post"
					action="${ctxPath}/manage/activity/category/upsert.do"
									...
									.click(
											function() {
												document.location.href = _ctxPath
														+ "/manage/activity/category/toQuery.do";
											});
