    <%@ page language="java" pageEncoding="utf-8" %>
        ...
        <a href="${ctxPath}/studyresource/tanentlist.do" class="btn-link">
        ...
        <div class="col-sm-10">${ffstudy.title }</div>
        </div>
        ...
        src="http://qiniu.thdangjian.com/${ffstudy.cover }" />
        </div>
        </div>
        </div>
        <div class="form-group organr">
        ...
        src="http://qiniu.thdangjian.com/${ffstudy.banner }" />
        </div>
        ...
        <div class="col-sm-10">${ffstudy.content }</div>
        </div>
