						...
						<div class="col-sm-10">
							...
							<div class="f-left" style="width: 120px; padding-top: 10px">
								...
								<button type="button" class="btn bgm-teal btn-block comp"
									comp="type:'fileupload',attachesDiv:'attachesDiv',showAttach:true,showAttachCallback:doCallback,isPrivate:true">选择上传音频</button>
							</div>
						</div>
					</div>
					<div class="form-group organr">
						...
						<div class="col-sm-10">
							...
							<div class="f-left" style="width: 120px; padding-top: 10px">
								<button type="button" class="btn bgm-teal btn-block comp"
									comp="type:'fileupload',previewImgId:'coverimg',valueId:'cover',isPrivate:false">选择上传图片</button>
							</div>
						</div>
					</div>
					<div class="form-group">
