    ...
    <div class="card">
        <div class="card-body card-padding">
            <div class="my-titlebar">
                <a href="${ctxPath}/pc/score/category/toQuery.action" class="btn-link">
            ...
            <form id="scoreCategory" method="post"
                  action="${ctxPath}/pc/score/category/upsert.action" class="form-horizontal">
            ...
            $("#cancelBtn").click(
                function () {
                    document.location.href = _ctxPath
                        + "/pc/score/category/toQuery.action";
                });
