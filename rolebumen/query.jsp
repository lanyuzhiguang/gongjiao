		...
		<div class="card">
			<div class="card-body card-padding">
				<div class="my-titlebar">
					<a href="${ctxPath}/basic/user/toPartyQuery.do" class="btn-link"> <i
				...
				<form id="rolebumen" method="post"
					action="${ctxPath}/rolebumen/upsert.do" class="form-horizontal">
										...
										colModel : [
												...
												},
												{
													...
													formatter : function(
															...
															options,
															rowObject) {
														var v = "<a href='javascript:void(0);' onclick='remove(\""
																+ cellvalue
																+ "\")' class='m-r-10'>删除</a>";
