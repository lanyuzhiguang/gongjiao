                                            ...
                                            <table border="0">
                                                <thead>
	                                                <tr>
	                                                    ...
	                                                    <th style="width: 10%">学习积分</th>
	                                                    <th style="width: 10%">活跃积分</th>
	                                                </tr>
                                                </thead>
                                                <tbody id="tbs1">
	                                                <tr id="itms1" style="display: none;">
	                                                	<td id="numb"></td>
	                                                    <td id="noticeTitle1">标题标题标题标题标题标题标题标题</td>
	 ...
	 var laypage = layui.laypage
      ...
      var bumRanking=null;
        ...
        function getNoktD1(){
          $.ajax({
              type:"post",
              url:"${ctxPath}/score/scoreRankingUser.action",
              dataType:"json",
        ...
        function getNoticeItm1(){
        	...
        	for(i;i<maxLeng;i++){
        		...
        		listItem.find("#updateTime1").html(notd.scoreTotal);
